...
namespace IniParser.Parser
{
    ...
    internal class IniDataParser
    {
        ...
        public IniData Parse(string iniDataString)
        {
            ...
            try
            {
                ...
                for (int lineNumber = 0; lineNumber < lines.Length; lineNumber++)
                {
                    ...
                    {
                        var errorEx = new SeeSharpFileException(SeeSharpFileErrorCode.RuntimeError, ex.Message, ex);
        ...
        protected virtual void ProcessLine(string currentLine, IniData currentIniData)
        {
            ...
            throw new SeeSharpFileException(SeeSharpFileErrorCode.FileFormatError, 
        ...
        protected virtual void ProcessSection(string line, IniData currentIniData)
        {
            ...
            {
                throw new SeeSharpFileException(SeeSharpFileErrorCode.FileFormatError, "Section name is empty");
            }
            ...
            if (currentIniData.Sections.ContainsSection(sectionName))
            {
                ...
                throw new SeeSharpFileException(SeeSharpFileErrorCode.FileDataError, string.Format("Duplicate section with name '{0}' on line '{1}'", sectionName, line));
            }
        ...
        protected virtual void ProcessKeyValuePair(string line, IniData currentIniData)
        {
            ...
            if (string.IsNullOrEmpty(_currentSectionNameTemp))
            {
                ...
                {
                    throw new SeeSharpFileException(SeeSharpFileErrorCode.FileDataError, 
                        "key value pairs must be enclosed in a section");
                }
        ...
        protected virtual void HandleDuplicatedKeyInCollection(string key, string value, KeyDataCollection keyDataCollection, string sectionName)
        {
            ...
            {
                throw new SeeSharpFileException(SeeSharpFileErrorCode.FileDataError,
                    $"Duplicated key '{key}' found in section '{sectionName}");
            }

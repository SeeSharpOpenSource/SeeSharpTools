...
namespace IniParser
{
    ...
    /// </summary>
    internal class FileIniDataParser : StreamIniDataParser
    {
        /// <summary>
        ///     Ctor
        /// </summary>
        ...
        public IniData ReadFile(string filePath, Encoding fileEncoding)
        {
            ...
            {
                throw new SeeSharpFileException(SeeSharpFileErrorCode.FileFormatError, $"Could not parse file {filePath}", ex);
            }

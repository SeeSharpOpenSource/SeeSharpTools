...
{
    class ButtonSwitchArrayDesigner: ControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                if (actionLists == null)
                {
                    ...
                    actionLists.Add(new ButtonSwitchArrayActionList(this.Component));
                    //注意要在这边新建下面所以生成的类
                }
                return actionLists;
            }
    ...
    internal class ButtonSwitchArrayActionList : DesignerActionList
    {
        private ButtonSwitchArray colUserControl;
        //这一行主要是要根据你修饰的控件来选择

        private DesignerActionUIService designerActionUISvc = null;

        //The constructor associates the control with the smart tag list.
        public ButtonSwitchArrayActionList(IComponent component)
            : base(component)
        {
            this.colUserControl = component as ButtonSwitchArray;

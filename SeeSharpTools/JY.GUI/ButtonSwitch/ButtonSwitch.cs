...
{
    [DefaultValue("Checked"), DefaultEvent("ValueChanged"), ToolboxBitmap(typeof(ButtonSwitch), "ButtonSwitch.ButtonSwitch.PNG")]
    [Designer(typeof(ButtonSwitchDesigner))]
    public class ButtonSwitch : Control
    {
        ...
        public event CheckedChangedDelegate ValueChanged;

        #endregion Delegate and Event declarations

        #region Enums

        public enum ButtonSwitchStyle
        {
            Metro,
            Android,
            IOS5,
        ...
        private ButtonSwitchStyle _style = ButtonSwitchStyle.Metro;
        ...
        [Bindable(false)]
        [DefaultValue(typeof(ButtonSwitchStyle), "Metro")]
        [Category("Appearance")]
        [Description("Gets or sets the style of the ToggleSwitch")]
        public ButtonSwitchStyle Style
        {
            get { return _style; }
            set
            {
        ...
        public string CheckedString
        {
            get
            {
                return Value ? (string.IsNullOrEmpty(OnText) ? "ON" : OnText) : (string.IsNullOrEmpty(OffText) ? "OFF" : OffText);
            }
        }

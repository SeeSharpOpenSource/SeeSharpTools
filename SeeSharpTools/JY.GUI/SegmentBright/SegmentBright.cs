...
namespace SeeSharpTools.JY.GUI
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(SevenSegment), "SegmentBright.SegmentBright.bmp")]
    [Designer(typeof(SevenSegmentBrightDesigner))]
    public class SegmentBright : Control, ISupportInitialize
    {
        #region Nested Types
        /// <summary>
        ...
        private void DrawChars(Graphics g, float segmentWidth, float segmentInterval)
        {
            ...
            {
                if (m_value.Length >= totalElements)
                    beginIndex_right = 0;
                else
                    beginIndex_right = totalElements - m_value.Length;
            }
            for (int i = 0; i < totalElements; ++i)
            {
                ...
                if (m_enumAlign == Alignment.Left)
                {
                    if (i < m_value.Length)
                    {
                        DrawSingleCharWithFadedBk(g, subRect, ForeColor, m_colFadedColor, m_value[i],
                ...
                else
                {
                    ...
                    {
                        DrawSingleCharWithFadedBk(g, subRect, ForeColor, m_colFadedColor, m_value[i - beginIndex_right],
                            m_fBevelRate, segmentWidth, segmentInterval);
                    }
                    else
                    {
        ...
        /// The smoothing mode.
        /// </summary>
        private bool m_smoothingMode = true;
        /// <summary>
        ...
        System.ComponentModel.DefaultValue(false)]
        public bool IsBackgroundGradient
        {
            get
            {
        ...
        private int SegmentIntervalRatio
        {
            get
            {
        ...
        System.ComponentModel.DefaultValue(typeof(SeeSharpTools.JY.GUI.SegmentBright.Alignment), "Left")]

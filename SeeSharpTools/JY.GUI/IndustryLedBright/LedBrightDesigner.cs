...
namespace SeeSharpTools.JY.GUI
{
    ...
    internal class LedBrightDesigner : ControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                if (null == actionLists)
                {
                    ...
                    actionLists.Add(new LedBrightActionList(this.Component));
                }
                return actionLists;
            }
        }

        internal class LedBrightActionList : System.ComponentModel.Design.DesignerActionList
        {
            private LEDBright colUserControl;

            private DesignerActionUIService designerActionUISvc = null;

            //The constructor associates the control with the smart tag list.
            public LedBrightActionList(IComponent component)
                : base(component)
            {
                this.colUserControl = component as LEDBright;
            ...
            public LEDBright.LedBrghtStyle Style
            {
                get
                {
            ...
            public LEDBright.InteractionStyle Interacton
            {
                get
                {

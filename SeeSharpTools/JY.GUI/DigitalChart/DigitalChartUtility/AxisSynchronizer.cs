...
namespace SeeSharpTools.JY.GUI.DigitalChartUtility
{
    ...
    {
        private readonly DigitalChartAxis _masterAxis;
        private readonly DigitalChartAxis _slaveAxis;
        ...
        public AxisSynchronizer(DigitalChartAxis masterAxis, DigitalChartAxis slaveAxis)
        {

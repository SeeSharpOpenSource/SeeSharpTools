...
namespace SeeSharpTools.JY.GUI
{
    ...
    /// </summary>
    public class DigitalChartAxis
    {
        private DigitalChart _parentChart;
        private DigitalChartPlotArea _parentPlotArea;
        ...
        internal void Initialize(DigitalChart baseDigitalChart, DigitalChartPlotArea basePlotArea, Axis baseAxis)
        {
            this.Name = baseAxis.Name;
            this._parentChart = baseDigitalChart;
...
//                _baseAxis.Interval = Constants.ClearXInterval;
        ...
        internal void ApplyConfig(DigitalChartAxis template)
        {

...
{
    public class DigitalChartPlotArea
    {
...
//        private readonly AxisSynchronizer _xAxisSync;
        ...
        internal DigitalChartPlotArea(DigitalChart parentChart, ChartArea chartArea)
        {
            ...
            this._axisX = new DigitalChartAxis();
            this._axisX2 = new DigitalChartAxis();
            this._axisY = new DigitalChartAxis();
            this._axisY2 = new DigitalChartAxis();
            ...
            _xCursor = new DigitalChartCursor(_parentChart, this, chartArea.CursorX, chartArea.AxisX, "X cursor");
            _xCursor.Mode = DigitalChartCursor.CursorMode.Zoom;
            _yCursor = new DigitalChartCursor(_parentChart, this, chartArea.CursorY, chartArea.AxisY, "Y cursor");
            _yCursor.Mode = DigitalChartCursor.CursorMode.Disabled;
            _cursors[0] = _xCursor;
            _cursors[1] = _yCursor;
...
//            _xAxisSync = new AxisSynchronizer(_axisX, _axisX2);
        ...
        private DigitalChartAxis _axisX;
        ...
        private DigitalChartAxis _axisX2;
        /// <summary>
        /// X2 Axis
        /// </summary>
        [
        ...
        private DigitalChartAxis _axisY;
        ...
        private DigitalChartAxis _axisY2;
        /// <summary>
        /// Y2 Axis
        /// </summary>
        [
        ...
        private DigitalChartCursor _xCursor;
        /// <summary>
        /// X Cursor
        /// </summary>
        [
        ...
        private DigitalChartCursor _yCursor;
        /// <summary>
        /// Y Cursor
        /// </summary>
        [
...
//            _axisY2.SetLabelFormat(yMinInternval);
        ...
        // TODO 新增属性后需要同步
        internal void ApplyConfig(DigitalChartPlotArea template)
        {
        ...
        {
            if (DigitalChartCursor.CursorMode.Cursor != _xCursor.Mode || DigitalChartCursor.CursorMode.Cursor != _yCursor.Mode)
            {

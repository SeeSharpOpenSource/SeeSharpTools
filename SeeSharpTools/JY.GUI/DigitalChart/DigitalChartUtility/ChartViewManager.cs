...
namespace SeeSharpTools.JY.GUI.DigitalChartUtility
{
    ...
    {
        internal DigitalChartPlotArea MainPlotArea { get;}
        internal bool UseMainAreaConfig { get; set; }
        internal DigitalChartPlotAreaCollection SplitPlotAreas { get; }
...
//        public double MinYInterval { get; set; }
        ...
        private readonly DigitalChart _parentChart = null;
        private readonly Chart _plotChart = null;
        private readonly PlotManager _plotManager;

        internal ChartViewManager(DigitalChart parentChart, Chart plotChart, PlotManager plotManager)
        {
            this._parentChart = parentChart;
            this._plotChart = plotChart;
            this._plotManager = plotManager;
            this.MainPlotArea = new DigitalChartPlotArea(parentChart, plotChart.ChartAreas[0]);
            ...
            this.SplitPlotAreas = new DigitalChartPlotAreaCollection(parentChart, plotChart.ChartAreas);
            AdaptView();
        }
        ...
        internal void SetAxisLabelStyle()
        {
            ...
            foreach (DigitalChartPlotArea splitPlotArea in SplitPlotAreas)
            {
...
//            MainPlotArea.Height = 100;
        ...
        public void RefreshAxesRange(DigitalChartPlotArea plotArea)
        {
            double maxXRange = _plotManager.GetMaxXData();
            double minXRange = _plotManager.GetMinXData();
        ...
        private void AdaptMainPlotAreaAxesRange(double maxXRange, double minXRange)
        {
            ...
            if (_plotManager.HasSeriesInYAxis(MainPlotArea, DigitalChartAxis.PlotAxis.Secondary))
            {
                double maxY2Range;
                double minY2Range;
...
//            }
        ...
        private double GetMinYInterval(DigitalChartPlotArea plotArea)
        {
        ...
        public DigitalChartPlotArea GetHitPlotArea(HitTestResult result)
        {
            ...
            DigitalChartPlotArea hitPlotArea = null;

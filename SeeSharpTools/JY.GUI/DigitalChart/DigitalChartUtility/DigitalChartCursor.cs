...
//    [TypeConverter(typeof(ExpandableObjectConverter))]
    public class DigitalChartCursor
    {
        ...
        internal DigitalChartCursor(DigitalChart parentChart, DigitalChartPlotArea parentPlotArea, Cursor baseCursor, Axis baseAxis, string cursorName)
        {
...
//                    _baseAxis.ScaleView.Zoomable = true;
        ...
        // TODO 新增属性时需要更新该方法
        public void ApplyConfig(DigitalChartCursor template)
        {

...
using System.Linq;
using System.Text;
using SeeSharpTools.JY.GUI.DigitalChartData;
using SeeSharpTools.JY.GUI.DigitalChartEditor;
using SeeSharpTools.JY.GUI.DigitalChartTabCursorUtility;
...
namespace SeeSharpTools.JY.GUI
{
    ...
    /// </summary>
    [Designer(typeof(DigitalChartDesigner))]
    [ToolboxBitmap(typeof(DigitalChart), "DigitalChart.DigitalChart.bmp")]
    [DefaultEvent("AxisViewChanged")]
    public partial class DigitalChart : UserControl
    {
        ...
        // 当前选择的线条
        private DigitalChartSeries _hitSeries;
        // 当前激活的绘图区
        private DigitalChartPlotArea _hitPlotArea;
        // 游标管理窗体的实例
        private DigitalChartTabCursorInfoForm _tabCursorForm;
        ...
        public DigitalChartPlotAreaCollection SplitPlotArea => _chartViewManager.SplitPlotAreas;
        ...
        public DigitalChartAxis AxisX2
        {
        ...
        public DigitalChartCursor XCursor
        {
        ...
        public DigitalChartCursor[] Cursors
        {
            get { return _cursors; }
            set
            {
        ...
        [
            Browsable(true),
            DesignerSerializationVisibility(DesignerSerializationVisibility.Content),
            Editor(typeof (DigitalChartLineSeriesEditor), typeof (UITypeEditor)),
            Category("Design"),
            Description("Specify or get the attribute of all series."),
            EditorBrowsable(EditorBrowsableState.Never)
        ]
        public DigitalChartLineSeries LineSeries => _plotManager.LineSeries;
        ...
        public DigitalChartSeriesCollection Series => _plotManager.Series;
        ...
        [
            Browsable(false),
            DesignerSerializationVisibility(DesignerSerializationVisibility.Content),
            Editor(typeof(DigitalChartTabCursorCollectionEditor), typeof(UITypeEditor)),
            Category("Data"),
            Description("Tabcursor container. This property is just used for design time."),
            EditorBrowsable(EditorBrowsableState.Never)
        ]
        public DigitalChartTabCursorDesignTimeCollection TabCursorContainer { get; }
        ...
        public DigitalChartTabCursorCollection TabCursors { get; }
        ...
        /// </summary>
        public delegate void ViewEvents(object sender, DigitalChartViewEventArgs e);

        /// <summary>
        /// EasyChartX cursor changed event delegate
        /// </summary>
        public delegate void CursorEvents(object sender, DigitalChartCursorEventArgs e);

        /// <summary>
        /// EasyChartX tabcursor changed event delegate
        /// </summary>
        public delegate void TabCursorEvent(object sender, DigitalChartTabCursorEventArgs e);

        /// <summary>
        /// EasyChartX plot event delegate
        /// </summary>
        public delegate void PlotEvent(object sender, DigitalChartPlotEventArgs e);
        ...
        internal void OnAxisViewChanged(DigitalChartAxis axis, bool isScaleViewChanged, bool isRaiseByMouseEvent)
        {
            if (null == AxisViewChanged)
            {
                return;
            }
            DigitalChartViewEventArgs eventArgs = new DigitalChartViewEventArgs();
            eventArgs.Axis = axis;
        ...
        internal void OnCursorPositionChanged(DigitalChartCursor cursor, bool raiseByMouseEvent, int seriesIndex = -1)
        {
            if (null == CursorPositionChanged)
            {
                return;
            }
            DigitalChartCursorEventArgs eventArgs = new DigitalChartCursorEventArgs();
        ...
        internal void OnTabCursorChanged(DigitalChartTabCursor cursor, TabCursorOperation operation, DigitalChartPlotArea plotArea)
        {
            if (null == TabCursorChanged)
            {
                return;
            }
            DigitalChartTabCursorEventArgs eventArgs = new DigitalChartTabCursorEventArgs();
            eventArgs.Cursor = cursor;
        ...
        {
            BeforePlot?.Invoke(this, new DigitalChartPlotEventArgs() {ParentChart = this, IsClear = isClearOperation});
        }
        ...
        {
            AfterPlot?.Invoke(this, new DigitalChartPlotEventArgs() { ParentChart = this, IsClear = isClearOperation });
        }
        #endregion
        ...
        public DigitalChart()
        {
            ...
            _tabCursorForm = null;
            TabCursors = new DigitalChartTabCursorCollection(this, _chart, _chartViewManager.MainPlotArea);
            this.TabCursorContainer = new DigitalChartTabCursorDesignTimeCollection(TabCursors);
...
//            BindPlotSeriesAndChartView();
        ...
        {
            foreach (DigitalChartAxis axis in _chartViewManager.MainPlotArea.Axes)
            {
                axis.ZoomReset(resetTime);
            }
            foreach (DigitalChartPlotArea plotArea in _chartViewManager.SplitPlotAreas)
            {
                foreach (DigitalChartAxis axis in plotArea.Axes)
                {
                    axis.ZoomReset(resetTime);
                }
            }
        ...
        {
            DigitalChartAxis changedAxis = null;
            // X轴的缩放需要执行数据更新
        ...
        private string MoveCursorAndShowValue(DigitalChartPlotArea hitPlotArea, int seriesIndex)
        {
            DigitalChartCursor xCursor = hitPlotArea.XCursor;
            DigitalChartCursor yCursor = hitPlotArea.YCursor;
            ...
            DigitalChartAxis xAxis, yAxis;
            xAxis = DigitalChartAxis.PlotAxis.Primary == Series[seriesIndex].XPlotAxis
                ? hitPlotArea.AxisX
                : hitPlotArea.AxisX2;

            yAxis = DigitalChartAxis.PlotAxis.Primary == Series[seriesIndex].YPlotAxis
                ? hitPlotArea.AxisY
                : hitPlotArea.AxisY2;
        ...
        private void RefreshContextMenuItems()
        {
            ...
            ToolStripMenuItem_xAxisZoom.Checked = DigitalChartCursor.CursorMode.Zoom == _hitPlotArea.XCursor.Mode &&
                                                  DigitalChartCursor.CursorMode.Zoom != _hitPlotArea.YCursor.Mode;
            ToolStripMenuItem_yAxisZoom.Checked = DigitalChartCursor.CursorMode.Zoom != _hitPlotArea.XCursor.Mode &&
                                                  DigitalChartCursor.CursorMode.Zoom == _hitPlotArea.YCursor.Mode;
            ToolStripMenuItem_windowZoom.Checked = DigitalChartCursor.CursorMode.Zoom == _hitPlotArea.XCursor.Mode &&
                                                  DigitalChartCursor.CursorMode.Zoom == _hitPlotArea.YCursor.Mode;
...
//            toolStripSeparator_range.Visible = !_chartViewManager.IsSplitView;
        ...
        private void tabCursorToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            _tabCursorForm = new DigitalChartTabCursorInfoForm(this);
        ...
        private void Show_XYValueClear()
        {
            ...
            _hitPlotArea.XCursor.Mode = DigitalChartCursor.CursorMode.Disabled;
            _hitPlotArea.YCursor.Mode = DigitalChartCursor.CursorMode.Disabled;
        }
        /// <summary>
        ...
        private void Zoom_XAxisToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                _hitPlotArea.XCursor.Mode = DigitalChartCursor.CursorMode.Zoom;
                _hitPlotArea.YCursor.Mode = DigitalChartCursor.CursorMode.Disabled;
            }
//            RefreshCursorSeriesMenuItems();
        }
        ...
        private void Zoom_YAxisToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                _hitPlotArea.XCursor.Mode = DigitalChartCursor.CursorMode.Disabled;
                _hitPlotArea.YCursor.Mode = DigitalChartCursor.CursorMode.Zoom;
            }
//            RefreshCursorSeriesMenuItems();
        }
        /// <summary>
...
//            RefreshCursorSeriesMenuItems();
        ...
        private void Show_XYValuetoolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (ToolStripMenuItem_showValue.Checked)
            {
                ...
                _hitPlotArea.XCursor.Mode = DigitalChartCursor.CursorMode.Cursor;
                _hitPlotArea.YCursor.Mode = DigitalChartCursor.CursorMode.Cursor;
            }
            else
            {
                Show_XYValueClear();
...
//            _hitPlotArea?.AxisX2.ZoomReset();
        ...
        private void SetSeriesLineWidth(object sender, EventArgs e)
        {
            ...
            DigitalChartSeries.LineWidth lineWidth;
        ...
        private void SetSeriesLineType(object sender, EventArgs e)
        {
            ...
            DigitalChartSeries.LineType interpolation;
        ...
        private void SetSeriesMarkerType(object sender, EventArgs e)
        {
            ...
            DigitalChartSeries.MarkerType markerType;
        ...
        {
            Form yAxisRangeForm = new DigitalChartRangeYConfigForm(_hitPlotArea);
            Point clickPoint = this._chart.PointToClient(Control.MousePosition);//鼠标相对于窗体左上角的坐标
        ...
        internal void RefreshAxesRange(DigitalChartPlotArea plotArea)
        {
            _chartViewManager.RefreshAxesRange(plotArea);
        }

        internal Series GetCursorSeries(DigitalChartPlotArea plotArea)
        {
        ...
        private bool IsCursorMode(DigitalChartPlotArea plotArea)
        {
            if (null == plotArea)
            {
                return false;
            }
            return DigitalChartCursor.CursorMode.Cursor == _hitPlotArea.XCursor.Mode &&
                   DigitalChartCursor.CursorMode.Cursor == _hitPlotArea.YCursor.Mode;
        }

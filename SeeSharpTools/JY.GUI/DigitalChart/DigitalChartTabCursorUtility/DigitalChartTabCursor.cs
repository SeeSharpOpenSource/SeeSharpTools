...
namespace SeeSharpTools.JY.GUI
{
    ...
    /// </summary>
    public class DigitalChartTabCursor
    {
//        private EasyChartX _parentChart;
        private DigitalChartTabCursorCollection _collection;
        internal DigitalChartTabCursorControl Control { get; }

        /// <summary>
        /// Create a tab cursor instance
        /// </summary>
        public DigitalChartTabCursor()
        {
            this.Control = new DigitalChartTabCursorControl();
            this._name = "";
            this._value = 0;
        ...
        internal void Initialize(DigitalChartTabCursorCollection collection)
        {

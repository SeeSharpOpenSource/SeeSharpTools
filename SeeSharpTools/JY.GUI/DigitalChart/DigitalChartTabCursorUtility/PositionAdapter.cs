...
namespace SeeSharpTools.JY.GUI.DigitalChartTabCursorUtility
{
    internal class PositionAdapter
    {
        ...
        private readonly DigitalChartPlotArea _chartArea;
        ...
        public PositionAdapter(Chart baseChart, DigitalChartPlotArea plotArea)
        {
        ...
        public void MoveCursorToTarget(DigitalChartTabCursor cursor)
        {
        ...
        public void RefreshCursorValue(DigitalChartTabCursor cursor)
        {
            // 游标真实位置需要加上cursor视图和控件本身像素差的偏移
            int cursorPosition = cursor.Control.Location.X + DigitalChartTabCursorControl.ViewPixelOffset;

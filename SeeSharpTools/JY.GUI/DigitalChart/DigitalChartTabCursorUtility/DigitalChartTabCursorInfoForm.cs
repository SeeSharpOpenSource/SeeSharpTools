...
{
    public partial class DigitalChartTabCursorInfoForm : Form
    {
        private readonly DigitalChartTabCursorCollection _cursors;
        ...
        /// </summary>
        public DigitalChartTabCursorInfoForm(DigitalChart parentChart)
        {
            InitializeComponent();
        ...
        private void SetFormLocation(DigitalChart parentChart)
        {
        ...
        {
            _cursors.Add(new DigitalChartTabCursor());
            RefreshCursorInfo();
        }
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            foreach (int rowIndex in rowIndexes)
            {
                ...
                DigitalChartTabCursor deleteCursor = _cursors.First(item => item.Name.Equals(cursorName));
        ...
        private void RefreshCursorValue(object sender, DigitalChartTabCursorEventArgs eventArgs)
        {
            // 如果只有数据更新或者使能更新，则只刷新
        ...
        private void dataGridView_cursorInfo_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            DigitalChartTabCursor changeCursor = _cursors[e.RowIndex];

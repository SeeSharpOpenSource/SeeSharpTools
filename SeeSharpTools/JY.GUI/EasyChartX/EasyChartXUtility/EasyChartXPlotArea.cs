...
{
    public class EasyChartXPlotArea
    {
...
//            _xAxisSync = new AxisSynchronizer(_axisX, _axisX2);
        ...
        private EasyChartXAxis _axisX2;
        /// <summary>
        /// X2 Axis
        /// </summary>
        [
        ...
        private EasyChartXAxis _axisY2;
        /// <summary>
        /// Y2 Axis
        /// </summary>
        [
        ...
        private EasyChartXCursor _xCursor;
        /// <summary>
        /// X Cursor
        /// </summary>
        [
        ...
        private EasyChartXCursor _yCursor;
        /// <summary>
        /// Y Cursor
        /// </summary>
        [
...
//            _axisY2.SetLabelFormat(yMinInternval);
        ...
        {
            if (EasyChartXCursor.CursorMode.Cursor != _xCursor.Mode || EasyChartXCursor.CursorMode.Cursor != _yCursor.Mode)
            {

...
//    [Serializable]
    public class StripChartXSeries
    {
        public StripChartXSeries()
        {
            _name = "";
            _baseSeries = null;
//            _name = "Series";
            ...
            _xPlotAxis = StripChartXAxis.PlotAxis.Primary;
            _yPlotAxis = StripChartXAxis.PlotAxis.Primary;
        }

        private Series _baseSeries;
        private StripChartXSeriesCollection _seriesCollection = null;

        internal void SetSeriesCollecton(StripChartXSeriesCollection seriesCollection)
        {
        ...
        private StripChartXAxis.PlotAxis _xPlotAxis;
        ...
        public StripChartXAxis.PlotAxis XPlotAxis
        {
        ...
        private StripChartXAxis.PlotAxis _yPlotAxis;
        ...
        public StripChartXAxis.PlotAxis YPlotAxis
        {
        ...
        // 绑定StripChartXSeries和真实的Series，根据用户配置修改对应真实线条的配置
        ...
        // 取消配置的Series和StripChartXSeries的绑定

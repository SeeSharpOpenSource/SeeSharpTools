...
namespace SeeSharpTools.JY.GUI.StripChartXUtility
{
    ...
    {
        private readonly StripChartXAxis _masterAxis;
        private readonly StripChartXAxis _slaveAxis;
        ...
        public AxisSynchronizer(StripChartXAxis masterAxis, StripChartXAxis slaveAxis)
        {

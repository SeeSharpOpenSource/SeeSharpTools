...
namespace SeeSharpTools.JY.GUI
{
    ...
    internal class LedArrowDesigner : ControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                if (null == actionLists)
                {
                    ...
                    actionLists.Add(new LedArrowActionList(this.Component));
                }
                return actionLists;
            }
        }
    }
    internal class LedArrowActionList : System.ComponentModel.Design.DesignerActionList
    {
        private LedArrow colUserControl;

        private DesignerActionUIService designerActionUISvc = null;

        //The constructor associates the control with the smart tag list.
        public LedArrowActionList(IComponent component)
            : base(component)
        {
            this.colUserControl = component as LedArrow;
        ...
        public LedArrow.LedArrowStyle Style
        {
            get
            {
        ...
        public LedArrow.DirectionQ Direction
        {
            get
            {
        ...
        public LedArrow.InteractionStyle Interacton
        {
            get
            {
